  ...
  const experience = [
    {
      ...
      title: "Freelancer",
      description:
        "Working as a freelancer and building web applications using React, Node.js, express and MongoDB.",
    },
    {
      year: "2024 - 2025",
      ...
      description:
        "Leading development of web applications using Angular and postgres, Impex-query. Mentoring junior developers and implementing best practices.",
    },
    {
      year: "2024",
    ...
    },
    {
      ...
      description:
        "Developed responsive websites and web applications using modern JavaScript frameworks and CSS preprocessors.",
    },
  ];
  ...
  const education = [
    {
      ...
      description:
        "Graduated with honors. Specialized in web development and software engineering courses.",
    },
  ];
